...
public class AirlineReturnFilterAdapter extends RecyclerView.Adapter<AirlineReturnFilterAdapter.ViewHolder> {
    ...
    public interface OnAirlineClickListener {
        public void onAirlineClicked(List<FlightReturnListPojo.Airlines> mAirlistList);
    }

    public AirlineReturnFilterAdapter(Context mContext, OnAirlineClickListener onAirlineClickListener) {
