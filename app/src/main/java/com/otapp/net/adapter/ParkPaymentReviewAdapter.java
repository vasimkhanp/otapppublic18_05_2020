...
public class ParkPaymentReviewAdapter extends BaseAdapter {

    private Context mContext;
    private String mCurrency;
    private List<ThemeParkSuccessPojo.Fare> mSummaryList = new ArrayList<>();

    public ParkPaymentReviewAdapter(Context mContext, String mCurrency) {
        this.mContext = mContext;
        this.mCurrency = mCurrency;
    }


    public void addAll(List<ThemeParkSuccessPojo.Fare> mTempSummaryList) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        final ThemeParkSuccessPojo.Fare mSummary = mSummaryList.get(i);
