...
import com.otapp.net.Bus.Core.AvailableCurrecncy;

import java.util.ArrayList;

public class ReturnAvailableBus implements Parcelable {
    ...
    protected ReturnAvailableBus(Parcel in) {
    ...
    public static final Parcelable.Creator<ReturnAvailableBus> CREATOR = new Parcelable.Creator<ReturnAvailableBus>() {
        @Override
        public ReturnAvailableBus createFromParcel(Parcel source) {
            return new ReturnAvailableBus(source);
        }

        @Override
        public ReturnAvailableBus[] newArray(int size) {
            return new ReturnAvailableBus[size];
        }
    };
}
