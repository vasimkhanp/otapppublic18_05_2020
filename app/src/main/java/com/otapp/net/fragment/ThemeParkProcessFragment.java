...
public class ThemeParkProcessFragment extends BaseFragment implements View.OnClickListener {

    public static String Tag_ThemeParkProcessFragment = "Tag_" + "ThemeParkProcessFragment";
    ...
    public static ThemeParkProcessFragment newInstance() {
        ThemeParkProcessFragment fragment = new ThemeParkProcessFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_park_payment_process, container, false);
...
////
              //  wvProcess.loadUrl(mUrl);
                if(mPaymentType.equals(Constants.BNDL_PAYMENT_TYPE_DEBIT)) {
                    ...
                    String tpukey = hashMap.get("tp_ukey");
                    ...
                    Log.d("Log","tpukey "+tpukey );
                    Log.d("Log","custname "+custname );
                    Log.d("Log","custemail "+custemail );
                    Log.d("Log","custmob "+custmob );
                    Log.d("Log","custID "+custId);
                    Log.d("Log","promo "+promoId);
                    ...
                    try {
                        postData = "cardexp=" + URLEncoder.encode(cardexp, "UTF-8") + "&cardno=" + URLEncoder.encode(cardno, "UTF-8")
                                ...
                                + "&tp_ukey=" + URLEncoder.encode(tpukey, "UTF-8") + "&cust_name=" + URLEncoder.encode(custname, "UTF-8")
