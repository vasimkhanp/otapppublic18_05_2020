...
public class RestClient {
    ...
    // Debug
//    public static String API_PREFIX = "http://testing.managemyticket.net/android/api/";

    //Release
    public static String API_PREFIX = "https://www.managemyticket.net/android/api/";

    public static String MINT_KEY = "96488592";

    public static ApiInterface getClient(boolean isGson) {
