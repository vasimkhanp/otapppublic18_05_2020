...
public class BoardingPointAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<BDPoints> bdPointsArrayList;
    private BoardingPointInterface boardingPointInterface;

    public BoardingPointAdapter(Context context, ArrayList<BDPoints> bdPointsArrayList, BoardingPointInterface boardingPointInterface) {
        this.context = context;
        this.bdPointsArrayList = bdPointsArrayList;
        this.boardingPointInterface = boardingPointInterface;
    }
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                for (int i = 0; i < bdPointsArrayList.size(); i++) {
                    ...
                    Log.d("Log",bdPoints.getsBDID()+ "=" + bdPoints1.getsBDID());
                ...
                boardingPointInterface.onBoardingPointSelected(bdPoints);
