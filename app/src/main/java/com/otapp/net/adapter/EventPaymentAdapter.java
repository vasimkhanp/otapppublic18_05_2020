...
public class EventPaymentAdapter extends BaseAdapter {

    private Context mContext;
    private String mCurrency;
    private List<EventPaymentSummaryPojo.Summary> mSummaryList = new ArrayList<>();

    public EventPaymentAdapter(Context mContext, String mCurrency) {
        this.mContext = mContext;
        this.mCurrency = mCurrency;
    }


    public void addAll(List<EventPaymentSummaryPojo.Summary> mTempSummaryList) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.list_item_event_preview, null);
        ...
        final EventPaymentSummaryPojo.Summary mSummary = mSummaryList.get(i);
