...
public class MyBookingEventDetails extends AppCompatActivity {
  ...
  /*  @BindView(R.id.back)
   ...
   /* @BindView(R.id.toolbarTitle)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_booking_event_details);
            ...
            public void onResponse(Call<ApiResponse> call, Response<ApiResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (mApiResponse != null && mApiResponse.status.equalsIgnoreCase("200")) {
                        ...
                        Toast.makeText(getApplicationContext(), ""+mApiResponse.message, Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(getApplicationContext(), ""+mApiResponse.message, Toast.LENGTH_SHORT).show();
                    }
                }
