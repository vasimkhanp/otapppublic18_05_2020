...
public class PreferedAirlineFilterAdapter extends BaseAdapter {
    ...
    public PreferedAirlineFilterAdapter(Context mContext, OnAirlineClickListener onAirlineClickListener) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        final FlightOneListPojo.Airlines mAirline = mAirlineList.get(i);
